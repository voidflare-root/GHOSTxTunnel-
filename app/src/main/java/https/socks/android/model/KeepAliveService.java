...
public class KeepAliveService extends Service {
    ...
    private void a(int i, Intent intent) {
        ...
        ((AlarmManager) getSystemService("alarm")).set(3, SystemClock.elapsedRealtime() + ((long) i), PendingIntent.getService(this, 42, intent, getKeepAlivePendingIntentFlags()));
    }

    private void a(Intent intent) {
        intent.setAction("com.nstudio.keepalive.action.UPDATE");
        ((AlarmManager) getSystemService("alarm")).cancel(PendingIntent.getService(this, 42, intent, getKeepAlivePendingIntentFlags()));
    }

    private int getKeepAlivePendingIntentFlags() {
    ...
    private void b(Intent intent) {
        new Thread(new Runnable() {                     
                public void run() {
                    String str = isNetworkConnected() ? "Connected" : "Not Connected";
    ...
    private boolean isNetworkConnected() {
        try {
            ...
            Log.d("KeepAliveService", "Network status check failed", e);
            return false;
        }
    }
