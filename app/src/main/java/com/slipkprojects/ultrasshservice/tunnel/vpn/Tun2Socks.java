...
public class Tun2Socks extends Thread implements StreamGobbler.OnLineListener {
    ...
    private String mVpnIpv6Address;
	...
	public Tun2Socks(Context context, ParcelFileDescriptor vpnInterfaceFileDescriptor, int vpnInterfaceMTU, String vpnIpAddress,
		...
		this(context, vpnInterfaceFileDescriptor, vpnInterfaceMTU, vpnIpAddress, vpnNetMask, socksServerAddress,
				udpgwServerAddress, dnsResolverAddress, udpgwTransparentDNS, null);
	}

	public Tun2Socks(Context context, ParcelFileDescriptor vpnInterfaceFileDescriptor, int vpnInterfaceMTU, String vpnIpAddress,
		String vpnNetMask, String socksServerAddress, String udpgwServerAddress, String dnsResolverAddress, boolean udpgwTransparentDNS, String vpnIpv6Address) {
		mContext = context;
        ...
        mVpnIpv6Address = vpnIpv6Address;
	}
		...
		if (mListener != null) {
 		...
 		try {
			...
			if (mVpnInterfaceFileDescriptor != null){
				...
				if (mVpnIpv6Address != null && !mVpnIpv6Address.isEmpty()) {
					cmd.append(" --netif-ip6addr " + mVpnIpv6Address);
				}
				...
				cmd.append(" --loglevel " + Integer.toString(1));
