...
implements SkStatus.StateListener
{
	...
	private void logNativeRuntimeInfo() {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
			SkStatus.logInfo("Supported ABI: " + Arrays.toString(Build.SUPPORTED_ABIS));
		} else {
			SkStatus.logInfo("Supported ABI: " + Build.CPU_ABI + ", " + Build.CPU_ABI2);
		}
		SkStatus.logInfo("Native libs enabled: arm64-v8a, armeabi-v7a, x86, x86_64");
	}
	...
	public static final String NOTIFICATION_CHANNEL_BG_ID = "ghost_tunnel_bg";
    ...
    private void addVpnActionsToNotification(Notification.Builder nbuilder) {
	 ...
	 PendingIntent reconnectPendingIntent = PendingIntent.getBroadcast(this, 10, reconnectVPN, getFlags());
	 ...
	 PendingIntent disconnectPendingIntent = PendingIntent.getBroadcast(this, 11, disconnectVPN, getFlags());
