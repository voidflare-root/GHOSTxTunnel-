...
public class LocaleHelper {
	...
	@StringDef({ DEFAULT, HINDI })
	public @interface LocaleDef {
		String[] SUPPORTED_LOCALES = { DEFAULT, HINDI };
	}
	...
	public static String getLanguagePref(Context mContext) {
		String language = new Settings(mContext).getIdioma();
		if (!DEFAULT.equals(language) && !HINDI.equals(language)) {
			new Settings(mContext).setIdioma(DEFAULT);
			return DEFAULT;
		}
		return language;
	}
